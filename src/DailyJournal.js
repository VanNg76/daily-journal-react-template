...
import { addEntriesTags } from "./components/tag/TagManager";
...
export const DailyJournal = () => {
  ...
  const onFormSubmit = (entryData, entryTags) => {
    // send new entry, with tags attached to it, to backend. Access needed data at backend
